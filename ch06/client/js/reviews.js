    ...
    return (
      ...
      <form onSubmit={this.handleSubmit}>
        <div className="row">
          <div className="col-lg-6">
            <fieldset className="form-group">
              ...
              <input type="review" className="form-control" id="InputName"
		...
		onChange={this.handleAuthorChange} />
          ...
          <div className="col-lg-6">
            <fieldset className="form-group">
              ...
              <input type="review" className="form-control" id="InputEmail"
        ...
        <fieldset class="form-group">
          ...
          <textarea className="form-control" id="TextareaFeedback" rows="3"
